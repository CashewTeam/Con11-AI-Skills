#!/usr/bin/env python3
"""Validate Android architecture conventions for an spatial-design-to-app target.
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(description="Architecture conventions checker for spatial-design-to-app.")
