# detectHorizontalDragGestures | PICO Spatial SDK

ui:foundation / com.pico.spatial.ui.foundation.gesture / detectHorizontalDragGestures 
        ...
        Modifier.fillMaxSize() // make it as large as possible to receive touch event
            .pointerInput(Unit) {
                detectHorizontalDragGestures(
                    ...
                    // do something here
                    println("ondrag, delta=$dragAmount")
                }
            }
) { content, _ ->
    val entity = Entity()
