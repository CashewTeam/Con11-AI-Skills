# SideNavigationSection | PICO Spatial SDK

ui:design / com.pico.spatial.ui.design / SideNavigationSection 
...
#### Parameters
modifier 
Modifier to be applied to the section container 
content Padding 
Padding values for the section content 
title Padding 
Padding values specifically for the section title 
section Color 
The color of the section content. 
title 
Content representing the section header 
content 
content of this section, typically several  SideNavigationItem s 
#### Samples
```
