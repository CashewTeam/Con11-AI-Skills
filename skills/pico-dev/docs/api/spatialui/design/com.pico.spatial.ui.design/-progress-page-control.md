# ProgressPageControl | PICO Spatial SDK

ui:design / com.pico.spatial.ui.design / ProgressPageControl 
# ProgressPageControl
```kotlin
@Composable
...
current Progress 
The current progress of the page indicator. 
modifier 
...
max Display Count 
The maximum number of pages that can be displayed at once in the page indicator. The default value is  PageControlDefaults.ProgressMax . 
page Control Spec 
...
fun main() { 
   ...
   ProgressPageControl(
    ...
    enabled = true,
    maxDisplayCount = PageControlDefaults.ProgressMax,
