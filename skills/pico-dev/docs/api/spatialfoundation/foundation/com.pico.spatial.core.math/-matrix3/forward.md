...
foundation / com.pico.spatial.core.math / Matrix3 / forward 
# forward
```kotlin
val forward: Vector3
```
...
For a row-major matrix, this vector is extracted directly from the third row:  (m20, m21, m22) . 
...
#### Return
A  Vector3  representing the transformed Z-axis.