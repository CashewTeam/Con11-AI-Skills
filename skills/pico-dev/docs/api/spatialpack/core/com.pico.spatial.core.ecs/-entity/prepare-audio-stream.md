# prepareAudioStream | PICO Spatial SDK

core / com.pico.spatial.core.ecs / Entity / prepareAudioStream 
# prepareAudioStream
```kotlin
@MainThread
...
for buffer management and playback control. 
Audio Stream Config 
